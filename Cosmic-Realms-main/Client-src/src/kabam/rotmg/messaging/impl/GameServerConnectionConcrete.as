...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    private function onDamage(_arg1:Damage):void {
        ...
        if (_local4 != null) {
            ...
            var gameSprite:GameSprite = gs_ as GameSprite;
            // Enemy.Damage can still emit a visual DAMAGE packet while its
            // Invulnerable condition prevents HP from changing; do not count it.
            if (_arg1.objectId_ == this.playerId_ && !_local4.isInvulnerable() && gameSprite != null && gameSprite.bossCombatHUD != null) {
                gameSprite.bossCombatHUD.recordConfirmedDamage(_arg1.targetId_, _arg1.damageAmount_, _arg1.kill_);
            }
        }
    }
