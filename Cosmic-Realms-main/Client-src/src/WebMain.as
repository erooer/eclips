...
public class WebMain extends Sprite {
    ...
    {
        if (desktopEnvironmentConfigured) return;
        serverIP = stage.loaderInfo.parameters["Host"];
        if (serverIP == null)
            serverIP = "127.0.0.1"; //13.82.231.124
    }

    public static function configureDesktopEnvironment(host:String, port:int, environment:String):void {
        serverIP = host; serverPort = port; ENV = environment; desktopEnvironmentConfigured = true;
    }
