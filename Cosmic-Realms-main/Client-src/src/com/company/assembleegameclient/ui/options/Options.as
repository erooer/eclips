...
public class Options extends Sprite {
    ...
    private static function makeFpsModeSelectLabels():Vector.<StringBuilder> {
        return (new <StringBuilder>[new StaticStringBuilder("30"), new StaticStringBuilder("60")]);
    }
    ...
    private function addMiscOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("bossHealthBarDps", makeOnOffLabels(), [true, false], "Boss Health Bar & DPS", "Shows the health percentage and your confirmed five-second DPS against bosses.", null));
    ...
    private function addGraphicsOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("fpsMode", makeFpsModeSelectLabels(), ["30", "60"], "FPS", "", refreshFpsMode));
