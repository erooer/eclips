...
public class ObjectLibrary {
    ...
    private static const missingItemTextureWarnings_:Dictionary = new Dictionary();
    ...
    public static function getRedrawnTextureForItemGlowFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5):BitmapData {
        ...
        if (_local9 == null) {
            if (!missingItemTextureWarnings_[_arg1]) {
                missingItemTextureWarnings_[_arg1] = true;
                trace("[ObjectLibrary] Missing item XML for type 0x" + _arg1.toString(16) + "; rendering placeholder.");
            }
            return (TextureRedrawer.redraw(_local6, _arg2, _arg3, 0, _arg4, _arg5));
        }
