...
namespace common
{
    ...
    public class ServerSettings
    {
        ...
        // Simulation/update interval sent to clients.  Keep this a multiple of
        // the logic step (1000 / tps) so elapsed time remains exact.
        public int worldTickMs { get; set; } = 100;
        // These apply only to ordinary player drops and temporary portals made
        // in Nexus; permanent hub portals and dungeon-specific timers retain
        // their source-defined behaviour.
        public int nexusDroppedItemLifetimeMs { get; set; } = 60000;
        public int nexusTemporaryPortalLifetimeMs { get; set; } = 60000;
