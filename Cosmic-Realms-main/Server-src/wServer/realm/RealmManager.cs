...
namespace wServer.realm
{
    ...
    public class RealmManager
    {
        ...
        public void Run()
        {
            ...
            // their dynamic portals on the first deterministic logic pass.
            Logic.AddPendingAction(_ =>
            {
                foreach (var portal in Worlds.Values.SelectMany(w => w.StaticObjects.Values).OfType<entities.Portal>())
                    portal.PrepareSpawnedDestination();
            });
