     ...
     .Init("LH Grotto Bat",
        ...
        .Init("LH Marble Teleporter",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new State("1",
                        // (35, 48) is an empty/black Lost Halls map tile.  The
                        // Marble Colossus boss room is centred at (45, 136);
                        // use the walkable floor immediately north of it.
                        new TeleportPlayer(8, 45, 132, true)
                )
            )
            )
