...
namespace wServer.logic
{
    ...
    {
        private _ StarfallObservatory = () => Behav()
            .Init("Astral Wing Guardian", new State(new StayBack(.3, 10), new Shoot(15, count: 5, shootAngle: 18, coolDown: 750)))
            .Init("Constellation Wing Seal", new State(new Shoot(12, count: 6, shootAngle: 20, coolDown: 900)))
